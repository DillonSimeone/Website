/**
 * anomaly.js  EGravity Falls Anomaly Tracking & Puzzle Logic
 */
...
export class AnomalySystem {
        ...
        if (!document.getElementById('puzzle-module')) {
            ...
            mod.innerHTML = `
                <div class="terminal-box" style="padding:0; border:none; border-radius:12px; overflow:hidden; display:flex; justify-content:center; align-items:center; background:#000;">
                    <div id="puzzle-close">ÁE/div>
                    <img id="static-canvas" src="./assets/static.webm" style="width:${sz}px; height:${sz}px; display:block; object-fit:cover;" alt="">
                </div>
                <div class="input-box">
    ...
    triggerAnomaly() {
        ...
        if (this.isSolved) {
            // Already solved  Eshow reward in puzzle-module (gnome canvas is inside it)
    ...
    unlockReward() {
        this.isSolved = true;
        console.log("PUZZLE SOLVED  EUnlocking Reward");
    ...
    resetForGhost() {
        ...
        this._ensureReticle();
        console.log('AnomalySystem: resetForGhost  Eready for re-detection');
    }
