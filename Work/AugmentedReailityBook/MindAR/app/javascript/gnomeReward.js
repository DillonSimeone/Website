...
/**
 * GnomeReward  EShared Renderer Version
 * Renders the gnome vomiting shader as a Three.js Mesh in the main scene.
 * Uses the shared CoreAR renderer  Eno secondary WebGL context.
 */
export class GnomeReward extends THREE.Group {
    ...
    setup(sharedRenderer) {
        ...
        // Display mesh  Erenders as part of the main Three.js scene
    ...
    async load() {
        ...
        const pine = new THREE.TextureLoader().load(dir + 'pine_tree.webp');
    ...
    start() {
        ...
        this.visible = true;
        this._clock.start();
        console.log('🧁EGnomeReward: Started');
    }
    ...
    /**
     * Full reset for scanner disengage  Eclears render targets and state
    ...
    onUpdate(renderer) {
        ...
        // 2. Image pass  Erender the gnome shader to _rtImage
