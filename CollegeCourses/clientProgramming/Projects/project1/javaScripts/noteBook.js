		...
		function createNotebook()
		{
			...
			for(var i = 1; i < 9; i++)
			{
				...
				box.src = "./media/emptyCheckBox.webp";
				box.name = "Box " + i;
				...
				box.onclick = function()
								{
									if(this.alt == "Checked Box" )
									{
										...
										{
											//Save to Local
											localStorage.setItem(this.name, "./media/emptyCheckBox.webp");
										}
										else
										{
											//Save to Cookie.
											setCookie(this.name, "./media/emptyCheckBox.webp");
										}
									}
									else
									{
										...
										{
											//Save to Local
											localStorage.setItem(this.name, "./media/checkedCheckBox.webp");
										}
										else
										{
											//Save to Cookie.
											setCookie(this.name, "./media/checkedCheckBox.webp", 666);
										}
										//Save to cookie/locale
									}
								}
				if(localSupport) //The value for this is set to true if localStorage can be used.
				{
					...
					if(localStorage.getItem(box.name) == "./media/checkedCheckBox.webp")
						box.alt="Checked Box";
				}
				else
				{
					...
					if(getCookie(box.name) == "./media/checkedCheckBox.webp")
						box.alt="Checked Box";
				}
