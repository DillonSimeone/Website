# Haxel — Hardware Abstraction Layer Specification
...
Haxel defaults to **slow decay** at 30 kHz, configurable per channel via a `pwmMode` field exposed to the portal as a checkbox.
...
Haxel drives DRV2605L in two complementary modes:
