	var pages =
		{
			...
			1: 	{
				...
				choices: 
					...
					image: "./media/MurderAtColefaxManor.webp"
				},
				...
				69:
				{
					...
					story:
						[
							'"The first I heard of anything being amiss was when the maid  EPrismall  Escreamed, which prompted me to investigate. I was in the master bedroom at the time, preparing it for his lordship."'
						],
					choices:
						[
							'Continue'
				...
				72:
				{
					...
					story:
						[
							'"The late Mister Ludwick and Lord Colefax are Ewere old school friends from Cambridge. Once a year, they would meet up, alternating between Ludwick\'s Cardiff residence and the manor here."'
						],
					choices:
						[
							'Continue'
				...
				78:
				{
					...
					story:
						[
							'"I\'ve seen enough," you announce, getting up from your seat. "Lord Colefax, you are hereby placed under arrest on suspicion of engaging in wi E And that\'s as far as you get when a loud crack sounds out from behind you and a musket ball swiftly penetrates through the back of your skull, pulverises the majority of your brain, and then emerges out through the other side, spraying debris upon the parlour room floor, which is soon joined by your limp body.'
						],
					choices:
						[
							'Continue'
				...
				115:
				{
					...
					story:
						[
							'Judging by the labels on the bottles, some of which carry terribly long names, they all contain a different chemical. Some of the names are hard to make out, due to the levels of dust on most of the bottles. A bottle containing morphine, on the other hand, bares a handprint  Egloved, judging by the lack of fingerprints  Ein the middle of the dust, showing that it has been handled recently.',
				...
				205:
				{
					...
					story:
						[
							'"I don\'t know, but I can guess that Prismall  Eshe\'s the maid  Ewas doin\' some cleanin\', Skinner  Ehe\'s the chef  Ewas clearin\' the kitchen up from dinner, and that Blackwood was poncin\' about, makin\' Lord Colefax\'s room up all nice and proper. Not sure where Lord Colefax himself would\'ve been."'
						],
					choices:
						[
							'Continue'
				...
				208:
				{
					...
					story:
						[
							'"I don\'t keep a close track on my servants, but I can safely assume that McFadyen was performing his customary patrol of the grounds and that Skinner  Ethe chef  Ewas washing up in the kitchen. Prismall would have either been clearing up the dining room or doing some dusting and, based on the time, Blackwood would have been preparing my bed for the night."'
						],
					choices:
						[
							'Continue'
            ...
            268: 
                { 
                    ...
                    story: 
                    [
						'"I found a map of Cornwall in Lord Colefax\'s private study, with several towns  EBymarsh, Langston, Dunstow, and Caer Shaw  Emarked with crosses. Any idea what it means?"',
            ...
            288: 
                { 
                    ...
                    [
						...
						'"Your guess is as good as  Eif not better than  Emine. Last time I used one of his syringes was a few months back, when one of the horses got an infection."'
                    ], 
                    choices: 
                    [ 
						'Continue'
            ...
            308: 
                { 
                    ...
                    [
						...
						'"He could have been drugged. From my own experiences with opiates  Estrictly from a medical perspective  Eone\'s pupils tend to contract when under the influence of such substances."'
                    ], 
                    choices: 
                    [ 
						'Continue'
