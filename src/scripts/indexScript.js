...
window.superReveal = superReveal;
...
window.standardPalette = standardPalette;
...
window.randomPaletteColor = randomPaletteColor;
...
window.toggleLocalNav = toggleLocalNav;
...
window.initSectionGalleries = initSectionGalleries;
